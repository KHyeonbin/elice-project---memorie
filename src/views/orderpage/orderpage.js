...
function addAllEvents() {
  subtitleCart.addEventListener('click', navigate('/shopcart'));
...
async function insertMenberData() {
  const memberData = await Api.get('/users/memberlist');
  const { name, phoneNumber, address } = memberData;
